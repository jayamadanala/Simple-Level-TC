...
public class RETC_037 {
	...
	public void validLoginTest() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@href='http://realestate.upskills.in/region/plots-in-bangalore/']")).click();
		Thread.sleep(2000);
		driver.findElement(By.cssSelector("button.button.fullwidth")).click();
		Thread.sleep(2000);
